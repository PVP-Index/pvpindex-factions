...
public final class DatabaseManager {
     ...
     * the packaged JAR ({@code com.gyvex.pvpindex.lib.h2.Driver}) and falling
     * back to the unshaded one ({@code org.h2.Driver}) when running in tests.
     */
    static String detectH2DriverClass() {
        try {
            Class.forName("com.gyvex.pvpindex.lib.h2.Driver");
            return "com.gyvex.pvpindex.lib.h2.Driver";
     ...
     * ({@code com.gyvex.pvpindex.lib.mysql.cj.jdbc.Driver}) and falling back
     * to the unshaded one for test contexts.
     */
    static String detectMysqlDriverClass() {
        try {
            Class.forName("com.gyvex.pvpindex.lib.mysql.cj.jdbc.Driver");
            return "com.gyvex.pvpindex.lib.mysql.cj.jdbc.Driver";
        } catch (ClassNotFoundException ignored) {
