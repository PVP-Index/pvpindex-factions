...
import com.gyvex.pvpindex.factions.command.AdminCommandExecutor;
import com.gyvex.pvpindex.factions.command.AdminTabCompleter;
import com.gyvex.pvpindex.factions.command.FactionCommandExecutor;
import com.gyvex.pvpindex.factions.command.FactionTabCompleter;
import com.gyvex.pvpindex.factions.command.sub.CmdClaim;
import com.gyvex.pvpindex.factions.command.sub.CmdCreate;
import com.gyvex.pvpindex.factions.command.sub.CmdDemote;
import com.gyvex.pvpindex.factions.command.sub.CmdDesc;
import com.gyvex.pvpindex.factions.command.sub.CmdDisband;
import com.gyvex.pvpindex.factions.command.sub.CmdFly;
import com.gyvex.pvpindex.factions.command.sub.CmdGui;
import com.gyvex.pvpindex.factions.command.sub.CmdHelp;
import com.gyvex.pvpindex.factions.command.sub.CmdHome;
import com.gyvex.pvpindex.factions.command.sub.CmdInfo;
import com.gyvex.pvpindex.factions.command.sub.CmdInvite;
import com.gyvex.pvpindex.factions.command.sub.CmdJoin;
import com.gyvex.pvpindex.factions.command.sub.CmdKick;
import com.gyvex.pvpindex.factions.command.sub.CmdLeader;
import com.gyvex.pvpindex.factions.command.sub.CmdLeave;
import com.gyvex.pvpindex.factions.command.sub.CmdList;
import com.gyvex.pvpindex.factions.command.sub.CmdMap;
import com.gyvex.pvpindex.factions.command.sub.CmdNotify;
import com.gyvex.pvpindex.factions.command.sub.CmdPromote;
import com.gyvex.pvpindex.factions.command.sub.CmdRelation;
import com.gyvex.pvpindex.factions.command.sub.CmdRename;
import com.gyvex.pvpindex.factions.command.sub.CmdSetHome;
import com.gyvex.pvpindex.factions.command.sub.CmdTop;
import com.gyvex.pvpindex.factions.command.sub.CmdUnclaim;
import com.gyvex.pvpindex.factions.command.sub.CmdUnsetHome;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminBypass;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminClaim;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminDisband;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminHelp;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminReload;
import com.gyvex.pvpindex.factions.command.sub.admin.CmdAdminUnclaim;
import com.gyvex.pvpindex.factions.command.sub.bank.CmdBank;
import com.gyvex.pvpindex.factions.command.sub.warp.CmdWarp;
...
public final class CommandsBootstrapComponent extends AbstractBootstrapComponent {
    ...
    public boolean start(final BootstrapContext context) {
        ...
        final com.gyvex.pvpindex.factions.engine.AutoTerritoryModeCache autoModeCache =
